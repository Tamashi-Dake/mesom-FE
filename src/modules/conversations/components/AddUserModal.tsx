...
import { searchUsers } from "@/modules/search/api";
import Button from "@/components/shared/Button";
import useAddUserStore from "../store";
import DefaultHeader from "@/components/layout/DefaultHeader";
import LoadingSpinner from "@/components/common/LoadingSpinner";
import { useNavigate } from "react-router-dom";
import UserCardInterface from "@/components/shared/UserCardInterface";
import { AiOutlineClose } from "react-icons/ai";
import { useCurrentUser } from "@/app/providers/authProvider";
import { useMutation } from "@tanstack/react-query";
import { checkCreateConversationConditions } from "../api";
